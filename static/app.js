...
const I18N = {
 ...
 "res.firstCount": "No counts yet — set pars and do your first",
    ...
    "settings.team": "Team & access", "settings.teamHint": "Staff see recipes and the menu — never prices.", "auth.session": "Session",
 ...
 "res.firstCount": "Ainda sem contagens — defina pars e faça a primeira",
    ...
    "settings.team": "Equipa e acesso", "settings.teamHint": "A equipa vê receitas e carta — nunca preços.", "auth.session": "Sessão",
